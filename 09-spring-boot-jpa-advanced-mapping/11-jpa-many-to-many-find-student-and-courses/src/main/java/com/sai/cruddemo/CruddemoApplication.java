...
import com.sai.cruddemo.entity.Review;
...
public class CruddemoApplication {
	...
	private void updateInstructor(AppDAO appDAO) {
		...
		tempInstructor.setLastName("madhavarapu");
	...
	private void CreateInstructorWithCourse(AppDAO appDAO) {
		...
		InstructorDetail tempInstructorDetail = new InstructorDetail("https://youtu.be/67ka17XZE7s?si=XEN10eaczouOVSsa",
				"sai!!");
