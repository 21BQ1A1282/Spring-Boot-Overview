...
public class MyDemoLoggingAspect {
    ...
    @Around("execution(* com.sai.aopdemo.service.*.getFortune(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.sai.aopdemo.dao.AccountDAO.findAccounts(..))", throwing = "theExc")
    ...
    @AfterReturning(pointcut = "execution(* com.sai.aopdemo.dao.AccountDAO.findAccounts(..))", returning = "result")
